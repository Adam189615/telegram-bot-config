...
## Webhook-обработчик
- [x] Создать таблицы для хранения заметок и сообщений
- [x] Реализовать webhook-маршрут /api/webhook
- [x] Добавить обработку команд /start, /add, /list, /search, /clear
- [x] Реализовать логику сохранения заметок в БД
- [ ] Добавить отправку ответов пользователю через Telegram API
- [ ] Протестировать webhook с реальным Telegram-ботом
